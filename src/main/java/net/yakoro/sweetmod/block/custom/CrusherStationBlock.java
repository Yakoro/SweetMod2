...
public class CrusherStationBlock extends BlockWithEntity implements BlockEntityProvider {

    public CrusherStationBlock(Settings settings) {
        super(settings);
    }
    ...
    public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
        return checkType(type, ModBlockEntities.CRUSHER_STATION, CrusherBlockEntity::tick);
    }
}
