...
import net.yakoro.sweetmod.block.custom.CrusherStationBlock;
...
public class CrusherBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    public CrusherBlockEntity(BlockPos pos, BlockState state) {
        super(ModBlockEntities.CRUSHER_STATION, pos, state);
    ...
    public Text getDisplayName() {
        return Text.literal("Wheat Crusher");
    }
    ...
    protected void writeNbt(NbtCompound nbt) {
        ...
        nbt.putInt("crusher_station_progress", progress);
    }
    ...
    public void readNbt(NbtCompound nbt) {
        ...
        super.readNbt(nbt);
        progress = nbt.getInt("crusher_station_progress");
    }
    ...
    private static void craftItem(CrusherBlockEntity entity) {
        ...
        if(hasRecipe(entity)) {
            ...
            entity.setStack(2,new ItemStack(ModItems.FLOUR,
    ...
    private static boolean hasRecipe(CrusherBlockEntity entity) {
        ...
        boolean hasWheatInFirstSlot = entity.getStack(1).getItem() == Items.WHEAT;

        return hasWheatInFirstSlot && canInsertAmountIntoOutputSlot(inventory) && canInsertItemIntoOutputSlot(inventory, ModItems.FLOUR);
